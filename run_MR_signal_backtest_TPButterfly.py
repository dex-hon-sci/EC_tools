...
from EC_tools.strategy.ArgusTailPButterflyStrategy import ArgusTailPButterflyStrategy
...
from app.run_gen_TS_dir import run_gen_signal_bulk
...
def run_main(strategy_name, 
    ...
    strategy = ArgusTailPButterflyStrategy
    ...
    MASTER_SIGNAL_FILENAME = RESULT_FILEPATH + '/ArgusTailPButterfly/test_signal3.csv'
    ...
    MASTER_PNL_FILENAME = RESULT_FILEPATH + '/ArgusTailPButterfly/test_PNL3.pkl'
    ...
    if backtest_runtype == "preload":
        ...
        PL.tradebook_filename = RESULT_FILEPATH + "/ArgusTailPButterfly/test_PNL3.csv"
...
if __name__ == "__main__":
    ...
    run_main('argus_exact', 
             ...
             start_date, end_date,        
             buy_range = (0.05,0.5,0.03),
             sell_range =(0.95,0.5,0.97),

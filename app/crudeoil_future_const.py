...
DAILY_CUMAVG_MONTH_PKL = DATA_FILEPATH +"/pkl_vault/crudeoil_future_daily_cumavg_full.pkl"
MINUTE_CUMAVG_MONTH_PKL = DATA_FILEPATH +"/pkl_vault/crudeoil_future_minute_cumavg_full.pkl"
...
SYMBOL_LIST = ["CLc1", "CLc2", "HOc1", "HOc2", "RBc1", "RBc2", 
               "QOc1", "QOc2", "QPc1", "QPc2"]
SYMBOL_LIST_SHORT = ["CLc1", "HOc1", "RBc1", "QOc1", "QPc1"]
...
TRAIL_PRICE_DELTA = {"CLc1": 0.8, "CLc2": 0.8,
                     "HOc1": 0.05, "HOc2": 0.05,
                     "RBc1": 0.05, "RBc2": 0.05,
                     "QOc1": 0.8, "QOc2": 0.8, 
                     "QPc1": 5., "QPc2": 5.0}

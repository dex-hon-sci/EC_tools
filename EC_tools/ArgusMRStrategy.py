...
# =============================================================================
        ...
        NCONS,	NROLL = len(self.sub_cond_dict["Buy"]['NCONS'][0]), \
                                        len(data['lag_list'])
        ...
        # Degine the name for the Buy/Sell acti一人之下 on for each condition subgroups
    ...
    def gen_cond_info(self, data):
        
        # make a list that records the number of conditions
        NCOND_list = []
        for key in self._sub_buy_cond_dict:
            NCOND_list.append(len(self._sub_buy_cond_dict))

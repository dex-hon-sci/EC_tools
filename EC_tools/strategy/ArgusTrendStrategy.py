...
# -*- coding: utf-8 -*-
"""
Created on Wed May 14 14:45:38 2025
...
class ArgusTrendStrategy(Strategy):
    """
    """
    def __init__(self, 
        ...
        self.strategy_name = 'argus_trend'
    ...
    def run_cond(self, data: dict, 
        ...
        NCONS = 0#len(self._sub_buy_cond_dict['NCONS'][0])
        NROLL = len(data['lag_list'])

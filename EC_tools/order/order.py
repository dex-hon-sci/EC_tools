...
class Order(object):
    ...
    size: float = 1 # number of commodity unit in one contract
    fee: dict = None
    ...
    def __post_init__(self, 
        ...
        #print('correction_ratio', self.give_obj['quantity'] , 
        #      self.get_obj['quantity'], self.size)
...
class ExecuteOrder(object):
    ...
    def fill_pos(self, 
        ...
        if not self.order.status == OrderStatus.PENDING:

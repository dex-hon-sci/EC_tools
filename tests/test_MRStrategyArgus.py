...
def test_MRStrategyArgus_gen_data()->None:
    ...
    strategy_info, qunatile_info = \
        MRStrategyArgus(Test.curve_this_date).gen_data(history_data_lag5, apc_curve_lag5)
